...
- Preserve accessible light and dark themes and responsive keyboard-first behavior.

## Finish gate

Run `npm run verify`. For visual changes, also inspect the built site at desktop and mobile widths in both themes.
